...
<table width="100%">
  <tr>
    <td width="33%" valign="top" align="left">
      <h4>🎙️ Voice AI Agent</h4>
      <p>Real-time conversational AI system built with low latency audio streaming, OpenAI API, and automated flow integrations.</p>
      <p>
        <code>Python</code> <code>OpenAI</code> <code>FastAPI</code>
      </p>
    </td>
    <td width="33%" valign="top" align="left">
      <h4>🔌 MCP Server Bridge</h4>
      <p>A Model Context Protocol server bridge to securely connect LLMs to local data repositories and terminal systems.</p>
      <p>
        <code>TypeScript</code> <code>Docker</code> <code>Kubernetes</code>
      </p>
    </td>
    <td width="33%" valign="top" align="left">
      <h4>🏥 Healthcare AI Diagnostics</h4>
      <p>An intelligent scheduling portal integration managing FHIR appointments and clinical diagnostic workflows.</p>
      <p>
...
- 🔧 Styled profile README with neon animated typewriter banner and stats
